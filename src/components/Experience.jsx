              ...
              <div className="timeline-centered">
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      <h2>Software Engineer I at <a href="https://khoros.com" target="_blank" rel="noopener noreferrer">Khoros</a> <span>2020-present</span></h2>
                      {/* <p></p> */}
                    </div>
                  </div>
                </article>
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      <h2>Software Developer at <a href="https://www.brandly.com" target="_blank" rel="noopener noreferrer">Brandly</a> <span>2019-2020</span></h2>
                      <p>As a freelance developer for Brandly, I worked on new features like pagination on admin order histories, bug fixes, and mobile design.</p>
                    </div>
                  </div>
                </article>
